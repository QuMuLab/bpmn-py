...
pool = diagram.add_pool("")
swimlane = pool.add_swimlane("")
...
event_gateway_1 = swimlane.add_gateway("", gateway_type.eventBasedGateway)
...
event_gateway_2 = swimlane.add_gateway("", gateway_type.eventBasedGateway)
